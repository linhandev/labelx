...
labelx data_annotated --labels labels.txt --nodata --labelflags '{.*: [occluded, truncated], person-\d+: [male]}'
```
...
```bash
labelx_draw_label_png data_dataset_voc/SegmentationClassPNG/2011_000003.png   # left
labelx_draw_label_png data_dataset_voc/SegmentationObjectPNG/2011_000003.png  # right
```
...
./labelx2coco.py data_annotated data_dataset_coco --labels labels.txt
```
